...
<!-- ** ** ** ** ** Part for the research ** ** ** ** ** -->
	...
	<INPUT TYPE="hidden" NAME="posted" value=1>
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
        		...
        		<td align="left" >					
      			...
      			<td align="left" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" ><tr>
                                         <td class="bar-search" >
	  				De: <select name="fromstatsday_sday">
					<? 
						for ($i=1;$i<=31;$i++){
			...
			<tr bgcolor="#cccccc">
				<td align="left" >					
					<font face="verdana" size="1" ><b>&nbsp;&nbsp;CAMPO DO UTILIZADOR</b></font>
				</td>				
				<td class="bar-search" align="left" >
...
<!-- ** ** ** ** ** HOURLY LOAD ** ** ** ** ** -->
<center>
	Selecione o intervalo de hora para ver os detalhes:<br/>
	...
	<!-- ** ** ** ** ** HOURLY LOAD ** ** ** ** ** -->
		<table class="bar-status" width="60%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr bgcolor="#cccccc">
			<td align="left">					
					<font face="verdana" size="1" ><b>&nbsp;&nbsp;INTERVALO DA HORA:</b></font>
				</td>				
				<td class="bar-search" align="center">
				...
				<select name="hourinterval">
					<? 
						for ($i=0;$i<=23;$i++){							
							echo '<option value="'.sprintf("%02d",$i)."\"> ".sprintf("%02d",$i).'h a '.sprintf("%02d",$i+1).'h </option>';
						}
					?>					
					</select>
			...
			<tr bgcolor="#999999">
				<td align="left" >					
					<font face="verdana" size="1" ><b>&nbsp;&nbsp;TIPO DE GR&Aacute;FICO :</b></font>
				</td>				
				<td class="bar-search" align="center">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;
				<select name="typegraph">
					<option value="fluctuation"> GR&Aacute;FICO FLUTUANTE</option> 
                                        <option value="watch-call" selected> GR&Aacute;FICO DE CHAMADAS ATENDIDAS</option>
				</select>
			...
			<tr bgcolor="#cccccc">
                        ...
                        <td colspan="2" class="bar-search" align="center">
                                <input type="image"  name="image16" align="top" border="0" src="images/button-search.gif" />				
