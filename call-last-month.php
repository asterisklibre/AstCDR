...
$FG_TABLE_COL[]=array ("Data da Chamada", "calldate", "18%", "center", "SORT", "19");
...
$FG_HTML_TABLE_TITLE=" - Registo de Chamadas - ";
	...
	<INPUT TYPE="hidden" NAME="posted" value=1>
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr bgcolor="#cccccc" >
        		<td align="left">					
      			...
      			<td align="left" >
					...
					Meses anteriores a comparar:
				 	<select name="months_compare">
					<option value="6" <?php if ($months_compare=="6"){ echo "selected";}?>>6 meses</option>
					<option value="5" <?php if ($months_compare=="5"){ echo "selected";}?>>5 meses</option>
					<option value="4" <?php if ($months_compare=="4"){ echo "selected";}?>>4 meses</option>
					<option value="3" <?php if ($months_compare=="3"){ echo "selected";}?>>3 meses</option>
					<option value="2" <?php if (($months_compare=="2")|| !isset($months_compare)){ echo "selected";}?>>2 meses</option>
					<option value="1" <?php if ($months_compare=="1"){ echo "selected";}?>>1 m&ecirc;s</option>
					</select>
					</td></tr></table>
	  			</td>
    		</tr>	
			...
			<tr bgcolor="#999999">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                    <tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="dst" value="<?=$dst?>"></td>
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="1" <?if((!isset($dsttype))||($dsttype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="2" <?if($dsttype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="3" <?if($dsttype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="dsttype" value="4" <?if($dsttype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr bgcolor="#cccccc">
				<td align="left" >					
				...
				<td class="bar-search" align="left" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="src" value="<?echo "$src";?>"></td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="1" <?if((!isset($sourcetype))||($sourcetype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="2" <?if($sourcetype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="3" <?if($sourcetype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="sourcetype" value="4" <?if($sourcetype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr bgcolor="#999999">
				<td class="bar-search" align="left" >				
				...
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="1" <?if((!isset($clidtype))||($clidtype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="2" <?if($clidtype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="3" <?if($clidtype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="clidtype" value="4" <?if($clidtype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr bgcolor="#cccccc">
				<td align="left" >					
				...
				<td class="bar-search" align="left" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0" ><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="userfield" value="<?echo "$userfield";?>"></td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="1" <?if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="2" <?if($userfieldtype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="3" <?if($userfieldtype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="userfieldtype" value="4" <?if($userfieldtype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr bgcolor="#999999">
				<td class="bar-search" align="left" >				
					<font face="verdana" size="1" ><b>&nbsp;&nbsp;C&Oacute;DIGO DA CONTA</b></font>
				</td>				
				<td class="bar-search" align="left" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="accountcode" value="<?=$accountcode?>"></td>
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="1" <?if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="2" <?if($accountcodetype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="3" <?if($accountcodetype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" ><input type="radio" NAME="accountcodetype" value="4" <?if($accountcodetype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr bgcolor="#cccccc">
			<td align="left" >					
			...
			<tr bgcolor="#999999">
				...
				<td class="bar-search" align="center" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0" >
						<tr>
						<td align="right">							
...
<tbody><tr><td bgcolor="#000000">			
	...
	?>
		...
		<td align="right" nowrap="nowrap" bgcolor="<?=$FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>"><font face="verdana" size="1"><?=$tkey?></font></td>
