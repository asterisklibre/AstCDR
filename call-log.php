...
// THIS VARIABLE DEFINE THE COLOR OF THE HEAD TABLE
$FG_TABLE_ALTERNATE_ROW_COLOR[] = "#FFFFFF"; //#FFFFFF
$FG_TABLE_ALTERNATE_ROW_COLOR[] = "#F2F8FF"; //#F2F8FF
...
$FG_TABLE_COL[]=array ("Canal", "channel", "13%", "center", "", "30", "", "", "", "", "", "display_acronym");
$FG_TABLE_COL[]=array ("Origem", "src", "10%", "center", "", "30");
//$FG_TABLE_COL[]=array ("Clid", "clid", "12%", "center", "", "30");
$FG_TABLE_COL[]=array ("&Uacute;ltima A&ccedil;&atilde;o", "lastapp", "8%", "center", "", "30");
...
$FG_TABLE_COL[]=array ("Dura&ccedil;&atilde;o", "duration", "6%", "center", "SORT", "30", "", "", "", "", "", "$minute_function");
$FG_TABLE_COL[]=array ("Fluxo", "fluxo", "6%", "center", "", "30");
$FG_TABLE_COL[]=array ("Custo", "custo", "6%", "center", "", "30" );

//$FG_TABLE_COL[]=array ("Campo do Utilizador", "userfield", "8%", "center", "", "20");
//$FG_TABLE_COL[]=array ("C&oacute;digo de Conta", "accountcode", "8%", "center", "", "20");
$FG_TABLE_COL[]=array ("Audio da Chamada", "audiofile", "8%", "center", "", "50");
...
$FG_COL_QUERY='calldate, channel, src, lastapp, lastdata, dst, disposition, duration, fluxo, custo, audiofile';
...
$FG_HTML_TABLE_TITLE=" - Registro de Chamadas - ";
...
//  $SQLcmd = do_field("<a href='#'>".$SQLcmd."</a>", 'src');
...
if ($posted==1){
	...
	/************************/
	$QUERY = "SELECT substring(calldate,1,10) AS day, sum(duration) AS calltime, count(*) as nbcall FROM $FG_TABLE_NAME WHERE ".$FG_TABLE_CLAUSE." GROUP BY substring(calldate,1,10)"; //extract(DAY from calldate) 
	//echo "$QUERY";
		...
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			<tbody><tr>
        		<td class="bar-search" align="left" bgcolor="#cccccc">
					...
					<font face="verdana" size="1"><b>M&Ecirc;S</b></font>
				</td>
      			<td class="bar-search" align="left" bgcolor="#cccccc"> 
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#cccccc"><tr><td><!--#cddeff-->
	  				<input type="checkbox" name="frommonth" value="true" <? if ($frommonth){ ?>checked<?}?>> 
					De : <select name="fromstatsmonth">
					<?	$year_actual = date("Y");  	
			...
			<tr>
        		<td align="left" bgcolor="#999999">
					...
					<font face="verdana" size="1"><b>DIA</b></font>
				</td>
      			<td align="left" bgcolor="#999999">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#999999"><tr><td> <!-- acbdee -->
	  				<input type="checkbox" name="fromday" value="true" <? if ($fromday){ ?>checked<?}?>> De : 
					...
					<input type="checkbox" name="today" value="true" <? if ($today){ ?>checked<?}?>> A : 
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="dsttype" value="1" <?if((!isset($dsttype))||($dsttype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="dsttype" value="2" <?if($dsttype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="dsttype" value="3" <?if($dsttype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="dsttype" value="4" <?if($dsttype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr>
				<td align="left" bgcolor="#999999">					
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#999999"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="src" value="<?echo "$src";?>"></td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="sourcetype" value="1" <?if((!isset($sourcetype))||($sourcetype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="sourcetype" value="2" <?if($sourcetype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="sourcetype" value="3" <?if($sourcetype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="sourcetype" value="4" <?if($sourcetype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#cccccc">				
				...
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="clidtype" value="1" <?if((!isset($clidtype))||($clidtype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="clidtype" value="2" <?if($clidtype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="clidtype" value="3" <?if($clidtype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="clidtype" value="4" <?if($clidtype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr>
				<td align="left" bgcolor="#999999">					
                                    <font face="verdana" size="1"><b>&nbsp;&nbsp;CAMPO DE USU&Aacute;RIO</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#999999">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#999999"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="userfield" value="<?echo "$userfield";?>"></td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="userfieldtype" value="1" <?if((!isset($userfieldtype))||($userfieldtype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="userfieldtype" value="2" <?if($userfieldtype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="userfieldtype" value="3" <?if($userfieldtype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#999999"><input type="radio" NAME="userfieldtype" value="4" <?if($userfieldtype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#cccccc">				
				...
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="accountcodetype" value="1" <?if((!isset($accountcodetype))||($accountcodetype==1)){?>checked<?}?>>Exato</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="accountcodetype" value="2" <?if($accountcodetype==2){?>checked<?}?>>Come&ccedil;a com</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="accountcodetype" value="3" <?if($accountcodetype==3){?>checked<?}?>>Cont&eacute;m</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="accountcodetype" value="4" <?if($accountcodetype==4){?>checked<?}?>>Termina com</td>
				</tr></table></td>
			</tr>			
			<tr>
			<td align="left" bgcolor="#999999">					
			...
			<tr>
				<td class="bar-search" align="left" bgcolor="#cccccc">				
					<font face="verdana" size="1"><b>&nbsp;&nbsp;DURA&Ccedil;&Atilde;O</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#cccccc">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
				<td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="duration1" size="4" value="<?=$duration1?>"></td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration1type" value="4" <?if($duration1type==4){?>checked<?}?>>&gt;</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration1type" value="5" <?if($duration1type==5){?>checked<?}?>>&gt; =</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration1type" value="1" <?if((!isset($duration1type))||($duration1type==1)){?>checked<?}?>>=</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration1type" value="2" <?if($duration1type==2){?>checked<?}?>>&lt; =</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration1type" value="3" <?if($duration1type==3){?>checked<?}?>>&lt;</td>	
				<td width="5%" class="bar-search" align="center" bgcolor="#cccccc"></td>
				
				<td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="duration2" size="4" value="<?=$duration2?>"></td>			
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration2type" value="4" <?if($duration2type==4){?>checked<?}?>>&gt;</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration2type" value="5" <?if($duration2type==5){?>checked<?}?>>&gt; =</td>								
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration2type" value="2" <?if($duration2type==1){?>checked<?}?>>&lt; =</td>
				<td class="bar-search" align="center" bgcolor="#cccccc"><input type="radio" NAME="duration2type" value="3" <?if($duration2type==3){?>checked<?}?>>&lt;</td>	
				</tr></table>
				</td>
			</tr>	
			...
			<tr bgcolor="#999999">
        		<td class="bar-search" align="left"> </td>

				<td class="bar-search" align="right">
					
					Resultado : Minutos<input type="radio" NAME="resulttype" value="min" <?if((!isset($resulttype))||($resulttype=="min")){?>checked<?}?>> - Segundos <input type="radio" NAME="resulttype" value="sec" <?if($resulttype=="sec"){?>checked<?}?>>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!-- ** ** ** ** ** Part to display the CDR ** ** ** ** ** -->
			...
			<center>N&uacute;mero de Chamadas : <? if (is_array($list) && count($list)>0){ echo $nb_record; }else{echo "0";}?></center>
      <table width="<?=$FG_HTML_TABLE_WIDTH?>" border="0" align="center" cellpadding="0" cellspacing="0">
<TR bgcolor="#ffffff"> 
          <TD bgColor=#004a25 height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px">  <!-- #7f99cc -->
...
<TBODY>
				...
				?>
						...
						<?	//$FG_TABLE_COL[$i][1];			
						 ...
						 }elseif ($FG_TABLE_COL[$i][1] == "audiofile"){
						 	   if (strlen($record_display) > 0){
							   		echo '<audio controls preload="none" style="width: 230px"> <source src="monitor/'.$record_display.'.ogg" type="audio/ogg"/> </audio>';
							   }
						 }else{						 		
				...
				<?php					 
				  		...
				  		echo "N&atilde;o foram encontrados dados.";				  
				  }//end_if
				 ?>
                <TR> 
        ...
        <TR bgcolor="#ffffff"> 
          <TD bgColor=#004a25 height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px"> 
			<TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
              <TBODY>
                <TR> 
...
<!--		<td align="center" bgcolor="#006600"></td>-->
	...
	<tr bgcolor="#006600">
		...
		<td align="center"><font face="verdana" size="1" color="#ffffff"><b> <acronym title="Tempo de Conex&atilde;o M&eacute;dia">TCM</acronym> </b></font></td>
	...
	?>
		...
		<td align="right" nowrap="nowrap" bgcolor="<?=$FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>"><font face="verdana" size="1" ><?=$data[0]?></font></td>
...
<a href="export_pdf.php" target="_blank"><img src="./images/pdf.gif" border="0" /></a> <a href="export_pdf.php" target="_blank">Exportar para PDF</a>
</td>
<td>
<a href="export_csv.php" target="_blank" ><img src="./images/excel.gif" border="0"/></a> <a href="export_csv.php" target="_blank">Exportar para CSV</a>
</td></tr></table>
